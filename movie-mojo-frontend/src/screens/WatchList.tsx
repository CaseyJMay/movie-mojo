...
useEffect(() => {
  ...
  return (
    <View className='flex flex-col justify-start' style={styles.container}>
      <View className='w-full h-[106px] border-b-[1px] border-[#D4AF37]'>
        <Text className='w-full text-center mt-[35px] text-[#D4AF37] text-[42px] font-bebas'>{"Watchlist"}</Text>
      </View>
      <FlatGrid
